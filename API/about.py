...
class AboutDialog(QDialog):
    ...
    def init_ui(self):
        ...
        title = QLabel("Internet MDF")
        title.setFont(QFont("Times", 20))

        self.layout.addWidget(title)

        lbl1 = QLabel(
            '<center>Version 1.0.0<br>Copyright ©2023 Made by <a href="https://github.com/Omarpython">Omar Mohammed</a>.</center>'
        )
        ...
        github_pg = QLabel(
            '<a href="https://github.com/Omarpython/">Learn More </a>'
        )
