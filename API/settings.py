...
class UserSettings(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.settings_data = API.settings_data
    ...
    def addDefaultSearchEngineSelector(self):
        ...
        # Search engines
        self.searchEngineSelector.addItem("JSTOR")
        self.searchEngineSelector.addItem("Microsoft Academic")
        self.searchEngineSelector.addItem("Google Scholar")
        self.searchEngineSelector.addItem("Base")
        self.searchEngineSelector.currentTextChanged.connect(self.addDropDownItemToJson)

        self.lang = QtWidgets.QComboBox(self.mainWidget)
        self.lang.setEnabled(True)
        self.lang.setGeometry(QtCore.QRect(480, 80, 211, 33))

        self.lang.addItem("JSTOR")
        self.lang.addItem("Microsoft Academic")
        self.lang.addItem("Google Scholar")
        self.lang.addItem("Base")
        self.lang.currentTextChanged.connect(self.addDropDownItemToJson)


        if self.default_search_engine == "JSTOR":
            self.searchEngineSelector.setCurrentIndex(0)
        elif self.default_search_engine == "Microsoft Academic":
            self.searchEngineSelector.setCurrentIndex(1)
        elif self.default_search_engine == "Google Scholar":
            self.searchEngineSelector.setCurrentIndex(2)
        elif self.default_search_engine == "Base":
